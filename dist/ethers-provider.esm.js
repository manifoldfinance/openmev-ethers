...
var FlashbotsBundleProvider = /*#__PURE__*/function (_providers$JsonRpcPro) {
  ...
  FlashbotsBundleProvider.getMaxBaseFeeInFutureBlock = function getMaxBaseFeeInFutureBlock(baseFee, blocksInFuture) {
    var maxBaseFee = BigNumber.from(baseFee);
          ...
          switch (_context3.prev = _context3.next) {
            ...
            case 7:
              bundleTransactions = signedBundledTransactions.map(function (signedTransaction) {
                var transactionDetails = parse(signedTransaction);
                return {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 3:
              ...
              transactionDetails = parse(tx.signedTransaction);
            ...
            case 19:
              ...
              _context5.t0 = BigNumber.from(transaction.nonce);
              _context5.next = 32;
              break;
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 8:
              ...
              return _context11.abrupt("return", fetchJson(connectionInfo, _request));
...
//# sourceMappingURL=ethers-provider.esm.js.map
